...
class TransactionsPageDTO(BaseModel):
    ...
    transactions: Optional[List[TransactionDetailDTO]] = None
    __properties: ClassVar[List[str]] = ["month", "year", "page", "size", "totalElements", "totalPages", "hasNext", "hasPrevious", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [TransactionDetailDTO.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
