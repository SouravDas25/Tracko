...
class BudgetCategoryDTO(BaseModel):
    """
    BudgetCategoryDTO
    """ # noqa: E501
    ...
    actual_spent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="actualSpent")
    remaining_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="remainingBalance")
    __properties: ClassVar[List[str]] = ["categoryId", "categoryName", "allocatedAmount", "actualSpent", "remainingBalance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "actualSpent": obj.get("actualSpent"),
