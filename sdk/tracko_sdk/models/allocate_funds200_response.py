...
class AllocateFunds200Response(BaseModel):
    """
    AllocateFunds200Response
    """ # noqa: E501
    result: Optional[BudgetCategoryDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": BudgetCategoryDTO.from_dict(obj["result"]) if obj.get("result") is not None else None,
