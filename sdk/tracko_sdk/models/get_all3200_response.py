...
class GetAll3200Response(BaseModel):
    """
    GetAll3200Response
    """ # noqa: E501
    result: Optional[List[RecurringTransaction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [RecurringTransaction.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
