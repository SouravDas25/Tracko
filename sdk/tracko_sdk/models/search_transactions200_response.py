...
class SearchTransactions200Response(BaseModel):
    """
    SearchTransactions200Response
    """ # noqa: E501
    result: Optional[TransactionSearchResultDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": TransactionSearchResultDTO.from_dict(obj["result"]) if obj.get("result") is not None else None,
