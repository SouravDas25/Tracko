...
class GetAll1200Response(BaseModel):
    """
    GetAll1200Response
    """ # noqa: E501
    result: Optional[TransactionsPageDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": TransactionsPageDTO.from_dict(obj["result"]) if obj.get("result") is not None else None,
