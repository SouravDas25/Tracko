...
class GetHistory200Response(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[List[TransactionHistoryDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [TransactionHistoryDTO.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
