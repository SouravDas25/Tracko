...
class GetChartData200Response(BaseModel):
    """
    GetChartData200Response
    """ # noqa: E501
    result: Optional[AnalyticsResponseDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": AnalyticsResponseDTO.from_dict(obj["result"]) if obj.get("result") is not None else None,
