...
class Split(BaseModel):
    ...
    is_settled: Optional[StrictInt] = Field(default=None, alias="isSettled")
    contact_id: Optional[StrictInt] = Field(default=None, alias="contactId")
    __properties: ClassVar[List[str]] = ["id", "transactionId", "userId", "amount", "settledAt", "isSettled", "contactId"]
