...
class ExchangeRateApiResponse(BaseModel):
    ...
    """ # noqa: E501
    base_code: Optional[StrictStr] = Field(default=None, alias="baseCode")
    rates: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = None
    __properties: ClassVar[List[str]] = ["baseCode", "rates"]
