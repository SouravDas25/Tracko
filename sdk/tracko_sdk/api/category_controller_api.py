...
class CategoryControllerApi:
    ...
    def create6(
        self,
        category_save_request: CategorySaveRequest,
        ...
        :param category_save_request: (required)
        :type category_save_request: CategorySaveRequest
    ...
    def _create6_serialize(
        ...
        if category_save_request is not None:
            _body_params = category_save_request
    ...
    def _delete6_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/categories/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all5(
        ...
        _param = self._get_all5_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_all5_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
