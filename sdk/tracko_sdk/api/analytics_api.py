...
class AnalyticsApi:
    ...
    def get_chart_data(
        ...
        _param = self._get_chart_data_serialize(
    ...
    @validate_call
    def get_chart_data_with_http_info(
        self,
        transaction_type: StrictStr,
        start_date: datetime,
        end_date: datetime,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetChartData200Response]:
        """Get chart data with optional grouping and granularity
    ...
    @validate_call
    def get_chart_data_without_preload_content(
        self,
        transaction_type: StrictStr,
        start_date: datetime,
        end_date: datetime,
