...
class ExchangeRatesApi:
    ...
    def get_rates(
        self,
        base_currency: Annotated[str, Field(strict=True)],
    ...
    def _get_rates_serialize(
        ...
        if base_currency is not None:
            _path_params['baseCurrency'] = base_currency
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/exchange-rates/{baseCurrency}',
