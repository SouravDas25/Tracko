...
class JsonStoreControllerApi:
    ...
    def create4(
        ...
        :param json_store: (required)
        :type json_store: JsonStore
    ...
    def _delete4_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/json-store/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all4(
        ...
        _param = self._get_all4_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_all4_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_by_name(
        ...
        _param = self._get_by_name_serialize(
            name=name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_by_name_without_preload_content(
        self,
        name: Annotated[str, Field(min_length=0, strict=True, max_length=191)],
        _request_timeout: Union[
            None,
