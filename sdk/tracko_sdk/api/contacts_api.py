...
class ContactsApi:
    ...
    def create5(
        self,
        contact_save_request: ContactSaveRequest,
        ...
        :param contact_save_request: (required)
        :type contact_save_request: ContactSaveRequest
    ...
    def _create5_serialize(
        ...
        if contact_save_request is not None:
            _body_params = contact_save_request
