...
@app.command()
def summary(
    range: str = typer.Option(..., "--range", "-r", help="Range (weekly/monthly/yearly/fiveYearly/tenYearly/custom)"),
    transaction_type: str = typer.Option(..., "--type", "-t", help="Type (DEBIT/CREDIT/TRANSFER)"),
