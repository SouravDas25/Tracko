...
public class DebitTransactionService {
    ...
    @Transactional
    public Transaction createDebitTransaction(String userId, TransactionRequest request) {
    ...
    @Transactional
    public Transaction updateDebitTransaction(String userId, Transaction existing, TransactionRequest request) {
