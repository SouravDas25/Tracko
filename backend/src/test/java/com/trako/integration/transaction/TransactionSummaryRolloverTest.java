...
public class TransactionSummaryRolloverTest extends BaseIntegrationTest {
    ...
    public void testPreviousMonthSummaryAcrossAllAccounts() {
        ...
        createTransaction(accountA, incomeCategory, 1000.0, TransactionDbType.CREDIT, getDate(prevYear, prevMonth, 5));
        createTransaction(accountB, incomeCategory, 500.0, TransactionDbType.CREDIT, getDate(prevYear, prevMonth, 10));
        createTransaction(accountA, expenseCategory, 200.0, TransactionDbType.DEBIT, getDate(prevYear, prevMonth, 15));
        createTransaction(accountB, expenseCategory, 100.0, TransactionDbType.DEBIT, getDate(prevYear, prevMonth, 20));
    ...
    public void testBudgetRolloverUsesPreviousMonthSummaryCorrectly() {
        ...
        createTransaction(accountA, expenseCategory, 1000.0, TransactionDbType.DEBIT, getDate(prevYear, prevMonth, 15));
    ...
    public void testBudgetRolloverAccumulatesUnusedFundsAcrossMultipleMonths() {
        ...
        createTransaction(accountA, incomeCategory, 1000.0, TransactionDbType.CREDIT, getDate(yearA, monthA, 5));
        createTransaction(accountA, expenseCategory, 400.0, TransactionDbType.DEBIT, getDate(yearA, monthA, 10));
        ...
        createTransaction(accountA, incomeCategory, 500.0, TransactionDbType.CREDIT, getDate(yearB, monthB, 5));
        createTransaction(accountA, expenseCategory, 100.0, TransactionDbType.DEBIT, getDate(yearB, monthB, 10));
        ...
        createTransaction(accountA, incomeCategory, 800.0, TransactionDbType.CREDIT, getDate(yearC, monthC, 5));
        createTransaction(accountA, expenseCategory, 300.0, TransactionDbType.DEBIT, getDate(yearC, monthC, 10));
    ...
    private void createTransaction(Account account, Category category, Double amount, TransactionDbType type, Date date) {
