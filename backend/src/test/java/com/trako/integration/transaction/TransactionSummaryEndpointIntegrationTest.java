...
public class TransactionSummaryEndpointIntegrationTest extends BaseIntegrationTest {
    ...
    public void testGetMonthlySummaries_AllAccounts() throws Exception {
        // Acc 1: Jan +1000
        createTransaction(account1.getId(), category.getId(), 2024, Calendar.JANUARY, 1000.0, TransactionDbType.CREDIT);
        // Acc 2: Jan -200
        createTransaction(account2.getId(), category.getId(), 2024, Calendar.JANUARY, 200.0, TransactionDbType.DEBIT);
        // Total Jan: +800

        // Acc 1: Feb +500
        createTransaction(account1.getId(), category.getId(), 2024, Calendar.FEBRUARY, 500.0, TransactionDbType.CREDIT);
        // Total Feb: +500
    ...
    public void testGetYearlySummaries_AllAccounts() throws Exception {
        // 2023: Acc 1 +1000
        createTransaction(account1.getId(), category.getId(), 2023, Calendar.DECEMBER, 1000.0, TransactionDbType.CREDIT);

        // 2024: Acc 1 +2000, Acc 2 -500
        createTransaction(account1.getId(), category.getId(), 2024, Calendar.JANUARY, 2000.0, TransactionDbType.CREDIT);
        createTransaction(account2.getId(), category.getId(), 2024, Calendar.FEBRUARY, 500.0, TransactionDbType.DEBIT);
        // Net 2024: +1500
