package com.trako.integration.split;
...
public class SplitIntegrationTest extends BaseIntegrationTest {
    ...
    public void setup() {
        ...
        testTransaction.setTransactionType(TransactionDbType.DEBIT);
    ...
    public void testSettleSplit_doesNotCreateTransaction_and_allowsManualTransactionCreation() throws Exception {
        ...
        settlementTransaction.setTransactionType(TransactionDbType.CREDIT); // Credit/Income
